use crate::{create_registered_manager, AsyncRegisteredManager, contacts::{get_contacts_tui, get_contacts_cli}};
use anyhow::Result;
...
pub async fn get_my_profile_avatar_cli() -> Result<Option<Vec<u8>>> {
    ...
    match manager.retrieve_profile_avatar_by_uuid(uuid, profile_key).await {

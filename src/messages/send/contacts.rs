...
pub async fn send_message_to_contact_tui(
    recipient: String,
    text_message: String,
...
pub async fn send_message_to_contact_cli(recipient: String, text_message: String) -> Result<()> {
    let mut manager = create_registered_manager().await?;
...
pub async fn send_attachment_to_contact_tui(
    recipient: String,
    text_message: String,
    attachment_path: String,
    manager_mutex: AsyncRegisteredManager,
...
pub async fn send_attachment_to_contact_cli(
    recipient: String,
    text_message: String,
    attachment_path: String,
) -> Result<()> {
